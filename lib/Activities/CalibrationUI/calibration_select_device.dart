...
import '../../main.dart';
import 'calibrationChooseCustomerScreen.dart';

class CalibrationSelectDeviceScreen extends StatefulWidget {
  ...
  @override
  _CalibrationSelectDeviceScreenState createState() => _CalibrationSelectDeviceScreenState();



}

class _CalibrationSelectDeviceScreenState extends State<CalibrationSelectDeviceScreen> {
                                              ...
                                              Widget body = Wrap(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        Align(alignment: Alignment.centerLeft,child:  Text('ICE Serial',
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.all(8.0),
                                                    child: TextField(
                                                      controller: controllerIce,decoration: InputDecoration(
                                              ...
                                              Widget body = Wrap(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        Align(alignment: Alignment.centerLeft,child:  Text('Serial',
                                                          style: interSemiBold.copyWith(
                                                            color: ThemeManager().getBlackColor,
                                                            fontSize: width * 0.039,
                                                          ),
