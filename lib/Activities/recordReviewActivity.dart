...
class RecordViewStatefullActivityQuery extends StatefulWidget {
  ...
  RecordViewStatefullActivityQuery(
      {required this.width,
  ...
  @override
  _RecordViewStatefullActivityStateQu createState() =>
      _RecordViewStatefullActivityStateQu();
}

class _RecordViewStatefullActivityStateQu
    extends State<RecordViewStatefullActivityQuery> {
  int  prefferedDecimalPlace = 1 ;
  late Timer _timer;
  dynamic lastInfo;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold( appBar: PreferredSize(
      ...
      child:  ApplicationAppbar(). getAppbar(title:widget.snapshotHistoryItem["name"]),
    ),
      ...
      body: Stack(
        children: [
          Padding(
            ...
            child: Scaffold(backgroundColor: AppThemeManager().getScaffoldBackgroundColor(),
              key: scaffoldState,
...
//               ),
              body: StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (c, snapshotRecord) {
                    ...
                    if(dataJson.containsKey("decimalPlace")){
                        prefferedDecimalPlace = dataJson["decimalPlace"];
                      }
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      child: Wrap(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            width: MediaQuery.of(context).size.width,
                                            //  child: Text(snapshotRecord.data.data()["data"]["id"]),
                                            child: LineMultiColor(prefferedDecimalPlace: prefferedDecimalPlace,unit: getUnit(snapshotRecord.data!),
                                                data: jsonDecode(
                                                    snapshotRecord.data!.get("data")),
                                    ...
                                    dividingLine(),
                                    targetValueData("Target Value  ", snapshotRecord.data!.get("loadMode") == "kN"? double.parse(snapshotRecord.data!.get("targetLoad").toString()).toStringAsFixed(prefferedDecimalPlace) +" "+getUnit(snapshotRecord.data!): double.parse(snapshotRecord.data!.get("targetLoad").toString()).toInt().toString() + " "+getUnit(snapshotRecord.data!) ),

                                    dividingLine(),
                                    targetValueData("Max Value  ", (snapshotRecord.data!.get("loadMode") == "kN"? double.parse(snapshotRecord.data!.get("max").toString()).toStringAsFixed(prefferedDecimalPlace)+ " ": double.parse(snapshotRecord.data!.get("max").toString()).toInt().toString()) +" "+getUnit(snapshotRecord.data!) +" at " + Calculators(). durationToString(snapshotRecord.data!.get("maxAt"))),
                                    ...
                                    Container(
                                      ...
                                      child: Wrap(
                                        children: [
                                          ...
                                          //AttachmentUploadedStream
                                          StreamBuilder<int>(
                                              stream: AttachmentUploadedStream.getInstance().outData,
                                              builder: (c, snapshotRecord) {
                                                return Container(height: height * 0.07,
                                                  child: FutureBuilder<QuerySnapshot>(
                                                      ...
                                                      builder: (BuildContext context,
                                                        ...
                                                        // List<Widget> widgetsFullScreen = [];
                                                        List<dynamic> allFwi = [];
                                                        if ( snapshotattachment.connectionState == ConnectionState.done &&  snapshotattachment.hasData && snapshotattachment.data!.docs.length>0) {
                                                          ...
                                                          for (int q = 0; q < allAttachments.length; q++) {
                                                            ...
                                                            if (allAttachments[q].get("type")=="photo") {
                                                              ...
                                                              imageListForGrid.add(allAttachments[q].get("photoFile"));
                                                          ...
                                                          if(dataJson.containsKey("gridCount")){
                                                            if(dataJson["gridCount"] < imageListForGrid.length){
                                                              AppToast().show(message:imageListForGrid.length.toString() +" Photo");
                                                              AppFirestore(firestore: widget.customerFirestore, auth:FirebaseAuth.instance, projectId: widget.customerFirestore.app.options.projectId). makeImageGrid(customerFirestore: widget.customerFirestore,photoLInks: imageListForGrid,id: widget.id,);
                                      ...
                                      child: Wrap(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            width: MediaQuery.of(context).size.width,
                                            //  child: Text(snapshotRecord.data.data()["data"]["id"]),
                                            child: LineMultiColor(
                                                prefferedDecimalPlace :prefferedDecimalPlace,


                                                unit: getUnit(snapshotRecord.data!),
                                                data: jsonDecode(
                                                    snapshotRecord.data!.get("data")),
                                                max: snapshotRecord.data!.get("max"),
                                                target:
