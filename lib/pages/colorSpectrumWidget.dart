...
void main() {
 // runApp(MyColorSpectrum());
}
class MyColorSpectrum extends StatelessWidget {
  Function function;
  MyColorSpectrum(this.function);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SafeArea(
          child: ColorPicker(300,function),
        ),
      ),
    );
  }
...
class ColorPicker extends StatefulWidget {
  final double width;
  Function function;
  ColorPicker(this.width,this.function);
  @override
...
class _ColorPickerState extends State<ColorPicker> {
  ...
  _colorChangeHandler(double position) {
    ...
    setState(() {
      ...
      _currentColor = _calculateSelectedColor(_colorSliderPosition);
      _shadedColor = _calculateShadedColor(_shadeSliderPosition);
      //widget.function (""+int.parse(_shadedColor.red(31/55).toString()));
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        Center(child: Text(_shadedColor.toString())),
        Center(
