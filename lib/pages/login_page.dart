          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //           UserAuthStream.getInstance().signIn();
...
class _OtherProvidersSignInSectionState
  ...
  void _signInWithGithub() async {
    try {
      ...
      Scaffold.of(context).showSnackBar(SnackBar(
        content: Text("Sign In  with GitHub"),
      ));
    } catch (e) {
      print(e);
      Scaffold.of(context).showSnackBar(SnackBar(
  ...
  void _signInWithTwitter() async {
    try {
      ...
      if (kIsWeb) {
        ...
        userCredential = await _auth.signInWithCredential(credential);
        final user =userCredential!=  null&& userCredential.user!=null? userCredential.user:"";

    Scaffold.of(context).showSnackBar(SnackBar(
    content: Text("Sign In  with Twitter"),
    ));
      }
