...
class CommonUpdateDialog extends StatefulWidget {
  String title;
  String oldVal;
  Function(String) submittedCallback;
  CommonUpdateDialog(
      {Key? key,
      required this.title,
      required this.oldVal,
      required this.submittedCallback,
     })
      : super(key: key);
...
class _UpdateTitlePopUpState
    extends State<CommonUpdateDialog> {
 ...
 // var secondValue = "54";
  ...
  Widget build(BuildContext context) {
    TextEditingController titleController = new TextEditingController(text: widget.oldVal);
    titleController.text =  widget.oldVal;
   ...
   // loadValue = widget.oldLoad;
    ...
    return  Dialog(
      ...
      child: Container(margin: EdgeInsets.all(0),width: MediaQuery.of(context).size.width*0.9,
        child: Padding(
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: targetLoadFields(titleController),
          ),
          ...
          onTap: () {
            ...
            widget. submittedCallback(newSubSecondVal);
