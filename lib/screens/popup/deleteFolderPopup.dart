...
class DeleteFolderPopUp extends StatefulWidget {
  ...
  DeleteFolderPopUp({required this.title,required this.onClickAction,});

  @override
  _UpdatetextTitleState createState() => _UpdatetextTitleState();
}

class _UpdatetextTitleState extends State<DeleteFolderPopUp> {
          ...
          Container(height: 50,
            child: Stack(children: [
              Align(alignment: Alignment.centerLeft,child: Padding(
                ...
                child: Text("Do you want to delete "+widget.title,maxLines: 1,style: TextStyle(fontSize: 18,color: ThemeManager().getDarkGreenColor,fontWeight: FontWeight.bold),),
              ),),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //----------------------Alert text-------------------
                Text("All the subfolders and tests will be deleted",
