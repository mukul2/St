...
class FolderExistsPopUp extends StatefulWidget {
...
class _UpdatetextTitleState extends State<FolderExistsPopUp> {
  @override
  void initState() {
          ...
          Container(height: 50,
            child: Stack(children: [
              Align(alignment: Alignment.centerLeft,child: Padding(
                ...
                child: Text("Could not create folder",maxLines: 1,style: TextStyle(fontSize: 20,color: ThemeManager().getRedColor,fontWeight: FontWeight.bold),),
              ),),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //----------------------Alert text-------------------
                Text("Folder name allready exists",
