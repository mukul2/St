...
class UpdatetextTitle extends StatefulWidget {
  String title;
  FirebaseFirestore firestore;
  String id;
  UpdatetextTitle({required this.title,required this.firestore,required this.id});

  @override
  _UpdatetextTitleState createState() => _UpdatetextTitleState();
}

class _UpdatetextTitleState extends State<UpdatetextTitle> {
          ...
          GestureDetector(
            onTap: () {
              ...
              widget.firestore
                  .collection("pulltest")
                  .doc(widget.id)
                  .update({"name": newSubSecondVal}).then(
                      (value) {
                    Navigator.pop(context);
                  });
            },
            child: Container(
                margin: EdgeInsets.only(left: height * 0.04,right: height * 0.04,top: height * 0.04, bottom: height * 0.02),
                child: ButtonView(
