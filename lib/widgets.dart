...
class ScanResultTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ExpansionTile(
      ...
      trailing: InkWell(
        child: Text('Connect',style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),
      ...
      builder: (c, snapshot) {
        ...
        return ExpansionTile(
          title: ListTile(
            ...
            subtitle: Text(value!.length>3?convert2(value):value.toString()),
